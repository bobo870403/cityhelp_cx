...
//无redux的业务
import RoomLoad from '../../modules/home/roomLoan'
import EmergencyNotice from '../../modules/home/EmergencyNotice'
import PreviewApproval from '../../modules/home/previewApproval'
import Car from '../../modules/home/car'
import Vote from '../../modules/home/vote'
import MyInfo from '../../modules/my/myInfo'
import Global from '../../component/Global'
import Detail from '../../component/Detail'
import Buttons from '../../component/Buttons'
import Gov from '../../modules/government';
//加入redux的业务
import ListContainer from '../../containers/LifeContainer'
import NewsContainer from '../../containers/NewsContainer'
import ActivesContainer from '../../containers/ActiveContainer'
...
class home extends Component {
	...
	componentWillMount() {
			InteractionManager.runAfterInteractions(() => {
				...
				dispatch(HomeAction.home(isLoading));
			})
		}
		// 房屋试算
	_gotoRoomLoan() {
		...
		if (Home.isLoading) {
			return (
				<View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
					<Image style={{width:width,height:pxToDp(300)}} source={require('../../assets/loadings.gif')}/>
				</View>)
		}
		return (
	        	...
	        	<View style={{flexDirection:'row',backgroundColor:'transparent',alignItems:'center',marginTop:35,height:pxToDp(140)}}>
	        		<View style={{position:'absolute',left:25,top:20}}>
						<View style={{flexDirection:'row',justifyContent:'center'}}>
							<Image style={{width:pxToDp(30),height:pxToDp(30),resizeMode:'contain'}} source={require('../../assets/fine.png')}/>
					...
					<TouchableOpacity onPress={()=>this._gotoUserInfo()} style={{flex:1,alignItems:'center'}}>
						<Image style={{width:pxToDp(130),height:pxToDp(130),resizeMode:'contain'}} source={require('../../assets/head_portrait.png')}/>
					</TouchableOpacity>
	         	</View>
		        <View style={{flexDirection:'row',position:'absolute',bottom:10}}>
					<View style={{flex:1,alignItems:'center'}}>
						<Image style={{width:pxToDp(80),height:pxToDp(80)}} source={require("../../assets/bike.png")}/>
						<Text style={{color:'white',marginTop:3,fontSize:12}}>骑行</Text>
					</View>
					<View style={{flex:1,alignItems:'center'}}>
						<Image style={{width:pxToDp(80),height:pxToDp(80)}} source={require("../../assets/WIFI.png")}/>
						<Text style={{color:'white',marginTop:3,fontSize:12}}>V点</Text>
					</View>
					<View style={{flex:1,alignItems:'center'}}>
						<Image style={{marginTop:pxToDp(10),width:pxToDp(70),height:pxToDp(70)}} source={require("../../assets/zhoubian.png")}/>
						<Text style={{color:'white',marginTop:3,fontSize:12}}>周边</Text>
					</View>
					<View style={{flex:1,alignItems:'center'}}>
						<Image style={{width:pxToDp(80),height:pxToDp(80)}} source={require("../../assets/yaoyiyao.png")}/>
			...
			<View style={styles.headNews}>
				<View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
					<Image
        				...
        				source={require('../../assets/toutiao.png')}/>
				</View>
				<TouchableOpacity onPress={()=>this._gotoToutiao()} style={{flex:3,justifyContent:'center'}}>
					<Text style={{fontSize:pxToDp(26),color:'#666'}}>{Home.HomeList[0].contentTitle} </Text>
					<Text style={{fontSize:pxToDp(26),marginTop:10,color:'#666'}}>{Home.HomeList[1].contentTitle}</Text>
				</TouchableOpacity>
			</View>
			<View style={styles.btnView}>
				...
				<View style={styles.imgList}>
					<Buttons type={0} _onPress={()=>this._gotoListContaner('ms','美食')} text={'美食'} imguri={require('../../assets/lifeImg_02.jpg')}/>
					<Buttons type={0} _onPress={()=>this._gotoListContaner('qz','亲子')} text={'亲子'} imguri={require('../../assets/lifeImg_03.jpg')}/>
					<Buttons type={0} _onPress={()=>this._gotoListContaner('jjsh','居家')} text={'居家'} imguri={require('../../assets/lifeImg_04.jpg')}/>
					<Buttons type={0} _onPress={()=>this._gotoListContaner('jy','教育')} text={'教育'} imguri={require('../../assets/lifeImg_05.jpg')}/>
				</View>
				<View style={styles.tilte}>
					<View style={{width:pxToDp(6),height:pxToDp(23),backgroundColor:'#fd7e2d'}}></View>
				...
				<View style={styles.imgList}>
					<Buttons type={0} _onPress={()=>this._gotoListContaner('tchd-dzyl','大众娱乐')} text={'大众娱乐'} imguri={require('../../assets/lifeImg_07.jpg')}/>
					<Buttons type={0} _onPress={()=>this._gotoListContaner('ms','运动赛事')} text={'运动赛事'} imguri={require('../../assets/lifeImg_08.jpg')}/>
					<Buttons type={0} _onPress={()=>this._gotoListContaner('ms','登山旅游')} text={'登山旅游'} imguri={require('../../assets/lifeImg_09.jpg')}/>
					<Buttons type={0} _onPress={()=>this._gotoListContaner('ms','以舞会友')} text={'以舞会友'} imguri={require('../../assets/lifeImg_10.jpg')}/>
				</View>
				<View style={styles.tilte}>
					<View style={{width:pxToDp(6),height:pxToDp(23),backgroundColor:'#fd7e2d'}}></View>
				...
				<View style={styles.imgList}>
					<Buttons type={0} _onPress={()=>this._gotoListContaner('rwst_whcy','文化产业')} text={'文化产业'} imguri={require('../../assets/lifeImg_12.jpg')}/>
					<Buttons type={0} _onPress={()=>this._gotoListContaner('rwst_gjby','古今榜样')} text={'古今榜样'} imguri={require('../../assets/lifeImg_13.jpg')}/>
					<Buttons type={0} _onPress={()=>this._gotoListContaner('rwst_lsgj','历史古迹')} text={'历史古迹'} imguri={require('../../assets/lifeImg_14.jpg')}/>
					<Buttons type={0} _onPress={()=>this._gotoListContaner('rwst_msgy','民俗工艺')} text={'民俗工艺'} imguri={require('../../assets/lifeImg_15.jpg')}/>
				</View>
			</ScrollView>
		);
	}
